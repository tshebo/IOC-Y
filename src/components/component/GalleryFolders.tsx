...
const galleryFolders: GalleryFolder[] = [
  {
    ...
    images: [
      ...
      "/christmas-2025/cd (9).webp",
      "/christmas-2025/cd (10).webp",
      "/christmas-2025/cd (11).webp",
      "/christmas-2025/cd (12).webp",
      "/christmas-2025/cd (13).webp",
      "/christmas-2025/cd (14).webp",
      "/christmas-2025/cd (15).webp",
    ],
  },
  // {
  //   id: "rehabilitation",
